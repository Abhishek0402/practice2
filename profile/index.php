...
?>
                ...
                <div class="content__box hide" id="b2">
                    ...
                    <form id="upload_synopsis_form" class="synopsis" style="border:none;">
...
<!--                    <div class="uploadInst">* You must upload the google docs link.</div>-->
                    <div class="uploadInst">* Synopsis submission is closed.</div>
...
<!--                    <div class="uploadInst">* You can either upload either one or all four of them.</div>-->
                    <div class="uploadInst">* Option task submission is closed.</div>
